...
@Repository
public class TicketView3 extends AbstractView {
	...
	private void init() {
		...
		jTable.setModel((createLoteryModel(controller.retrieveAvailability(day))));
...
//						&& row != (this.getRowCount() - 1);
	...
	private void modifyModels() {
		...
		jTable.getColumnModel().getColumn(1).setMaxWidth(20);
		jTable.getColumnModel().getColumn(2).setMaxWidth(20);
		jTable.getColumnModel().getColumn(3).setMaxWidth(20);
		jTable.getColumnModel().getColumn(4).setMaxWidth(20);
	...
	private int countLotteries(){
		@SuppressWarnings("unchecked")
		List<List<Object>> lottery = ((DefaultTableModel) jTable.getModel())
				.getDataVector();
		int count = 0;
