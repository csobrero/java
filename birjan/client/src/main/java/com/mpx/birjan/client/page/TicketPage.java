...
public class TicketPage extends JFrame {
	...
	public TicketPage() {
		...
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"NACIONAL", "PROVINCIA"}));
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"PRIMERA", "MATUTINA", "VESPERTINA", "NOCTURNA"}));
